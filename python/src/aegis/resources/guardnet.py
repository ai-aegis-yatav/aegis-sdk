...
class SyncGuardNet(SyncResource):
    ...
    def analyze(self, content: str, **kwargs: Any) -> Dict[str, Any]:
        return self._post("/v3/defense/guardnet", json={"content": content, **kwargs})

    def jbshield(self, content: str, **kwargs: Any) -> Dict[str, Any]:
        return self._post("/v3/defense/jbshield", json={"content": content, **kwargs})

    def ccfc(self, content: str, **kwargs: Any) -> Dict[str, Any]:
        return self._post("/v3/defense/ccfc", json={"content": content, **kwargs})

    def muli(self, content: str, **kwargs: Any) -> Dict[str, Any]:
        return self._post("/v3/defense/muli", json={"content": content, **kwargs})

    def unified(self, content: str, **kwargs: Any) -> Dict[str, Any]:
        return self._post("/v3/defense/unified", json={"content": content, **kwargs})


class AsyncGuardNet(AsyncResource):

    async def analyze(self, content: str, **kwargs: Any) -> Dict[str, Any]:
        return await self._post("/v3/defense/guardnet", json={"content": content, **kwargs})

    async def jbshield(self, content: str, **kwargs: Any) -> Dict[str, Any]:
        return await self._post("/v3/defense/jbshield", json={"content": content, **kwargs})

    async def ccfc(self, content: str, **kwargs: Any) -> Dict[str, Any]:
        return await self._post("/v3/defense/ccfc", json={"content": content, **kwargs})

    async def muli(self, content: str, **kwargs: Any) -> Dict[str, Any]:
        return await self._post("/v3/defense/muli", json={"content": content, **kwargs})

    async def unified(self, content: str, **kwargs: Any) -> Dict[str, Any]:
        return await self._post("/v3/defense/unified", json={"content": content, **kwargs})
