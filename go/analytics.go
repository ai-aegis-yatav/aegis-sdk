...
func (s *AnalyticsService) Overview(ctx context.Context) (*models.AnalyticsOverview, error) {
	...
	if err := s.t.Do(ctx, "GET", "/v1/analytics/overview", nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (s *AnalyticsService) Judgments(ctx context.Context) (*models.AnalyticsJudgments, error) {
	...
	if err := s.t.Do(ctx, "GET", "/v1/analytics/judgments", nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (s *AnalyticsService) DefenseLayers(ctx context.Context) (*models.AnalyticsDefenseLayers, error) {
	...
	if err := s.t.Do(ctx, "GET", "/v1/analytics/defense-layers", nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (s *AnalyticsService) Threats(ctx context.Context) (*models.AnalyticsThreats, error) {
	...
	if err := s.t.Do(ctx, "GET", "/v1/analytics/threats", nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (s *AnalyticsService) Performance(ctx context.Context) (*models.AnalyticsPerformance, error) {
	...
	if err := s.t.Do(ctx, "GET", "/v1/analytics/performance", nil, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
